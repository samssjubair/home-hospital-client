...
const BlogPostManagePage = () => {
  ...
  useEffect(() => {
    axios
      .get(`${getBaseUrl()}/cms/blog_post/cms`)
      .then((res) => res.data)
      .then((data) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: function (data: any) {
        return (
          <>
            <Link href={`/admin/content/blog-post/edit/${data?.id}`}>
              <Button
                style={{
                  margin: "0px 5px",
                }}
  ...
  return (
    <div>
      ...
      <ActionBar title="Blog Posts">
        <div>
          <Link href="/admin/content/blog-post/create">
...
export default BlogPostManagePage;
