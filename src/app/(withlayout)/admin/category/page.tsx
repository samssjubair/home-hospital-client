...
const CategoryManagePage = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `${getBaseUrl()}/categories?page=${page}&size=${size}&sortBy=${sortBy}&sortOrder=${sortOrder}&searchTerm=${searchTerm}`
      )
      .then((res) => res.data)
      .then((data) => {
  ...
  const deleteHandler = async (id: string) => {
    ...
    try {
      const res = await axios.delete(`${getBaseUrl()}/categories/${id}`, {
        headers: {
